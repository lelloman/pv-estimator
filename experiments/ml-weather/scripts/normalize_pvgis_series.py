...
SOURCE_ID_BY_DATABASE = {
    ...
    "PVGIS-NSRDB": "pvgis_nsrdb_hourly",
}
CSV_FIELDS = [
    "source_id",
    "source_record_type",
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--raw-dir", type=Path, default=Path("experiments/ml-weather/runs/pvgis_series/raw"))
    parser.add_argument("--out", type=Path, default=Path("experiments/ml-weather/runs/pvgis_series/normalized/pvgis_series.csv.gz"))
