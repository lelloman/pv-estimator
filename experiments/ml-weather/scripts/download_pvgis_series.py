#!/usr/bin/env python3
"""Download PVGIS seriescalc hourly point data for source-model experiments."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--out-dir", type=Path, default=Path("experiments/ml-weather/runs/pvgis_series/raw"))
