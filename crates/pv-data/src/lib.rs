    ...
    SourceModelRegistry {
        ...
        sources: vec![
            ...
            source_model(SourceModelSeed {
                ...
                checkpoint_uri: "rtx.homelab:~/pv-estimator-gpu/results/pvgis_era5_climate_normals_compressor_768x8_tight_v1/best_model.pt",
                training_locations: 2_825,
                training_rows: 470_464_204,
                best_epoch: 77,
                best_validation_mae_mean: 7.124548,
            }),
            source_model(SourceModelSeed {
                ...
                training_rows: 241_310_667,
                best_epoch: 73,
                best_validation_mae_mean: 6.651263,
            }),
        ],
    }
}
