#!/usr/bin/env python3
"""Download NASA POWER hourly point data for source-model reproduction."""
    ...
    for attempt in range(retries + 1):
        try:
            request = urllib.request.Request(
                url,
                headers={
                    "User-Agent": "pv-estimator-source-model-reproduction/0.1",
...
def main() -> int:
    ...
    parser.add_argument("--locations", type=Path, default=Path("reproduction/source-models/config/global_grid_7056_locations_shuffled.csv"))
    parser.add_argument("--out-dir", type=Path, default=Path("reproduction/source-models/runs/global_grid_7056/raw/nasa_power_hourly"))
