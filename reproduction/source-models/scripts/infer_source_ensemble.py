...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--out-csv", type=Path, default=Path("reproduction/source-models/runs/source_ensemble_predictions.csv"))
    parser.add_argument("--out-json", type=Path, default=Path("reproduction/source-models/runs/source_ensemble_predictions.summary.json"))
    ...
    parser.add_argument("--pvgis-cache", type=Path, default=Path("reproduction/source-models/runs/source_ensemble_pvgis_cache"))
