...
def main() -> int:
    ...
    parser.add_argument("--raw-dir", type=Path, default=Path("reproduction/source-models/runs/global_grid_7056/raw/nasa_power_hourly"))
    parser.add_argument("--out", type=Path, default=Path("reproduction/source-models/runs/global_grid_7056/normalized/nasa_power_hourly.csv.gz"))
