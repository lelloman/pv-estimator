...
```text
reproduction/source-models/config/regional_benchmark_cities_120.csv
```
...
```text
reproduction/source-models/runs/source_ensemble_validation/regional_cities_120.csv
reproduction/source-models/runs/source_ensemble_validation/regional_cities_120.summary.json
reproduction/source-models/runs/source_ensemble_validation/regional_cities_120.estimates.json
reproduction/source-models/runs/source_ensemble_validation/regional_cities_120_broad_sarah3.csv
reproduction/source-models/runs/source_ensemble_validation/regional_cities_120_broad_sarah3.summary.json
```
