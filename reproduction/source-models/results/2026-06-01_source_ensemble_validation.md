...
```text
reproduction/source-models/runs/source_ensemble_validation/pvgis_benchmark_30.csv
reproduction/source-models/runs/source_ensemble_validation/pvgis_benchmark_30.summary.json
reproduction/source-models/runs/source_ensemble_validation/pvgis_italy_2.csv
reproduction/source-models/runs/source_ensemble_validation/pvgis_italy_2.summary.json
```
